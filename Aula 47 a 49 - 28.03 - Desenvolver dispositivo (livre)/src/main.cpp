...
#define pinBotaoEsq 14
#define pinBotaoDir 13
#define pinBotaoConfirm 12
...
void loop()
{
  ...
  if(leituraInicialBtEsq != leitura1) //se o botao foi clicado...
  {
   ...
   { 
    lcd.setCursor(posicao *5, 2); //posiciona o cursor
  ...
  if(leituraInicialBtConfirm != leitura3) //se o botao 3 foi clicado...
  {
   if(leitura3 == LOW) //e se o estado agora e low/ligado por conta do pullup
   {
     ...
     lcd.setCursor(5,0); //na casa 4 da linha 0...
     ...
     lcd.setCursor(10,0); //na casa 8 da linha 0...
     ...
     lcd.setCursor(15,0); //na casa 12 da linha 0...
